...
class Employee(models.Model):
    ...
    skills = models.ManyToManyField("Skills", related_name="skill_name")
    is_lead = models.BooleanField()
    team_lead = models.ForeignKey("self", on_delete=models.CASCADE, null=True, blank=True, related_name="lead")
    assigned_project = models.ForeignKey("Projects", on_delete=models.CASCADE, null=True, blank=True, related_name="discription")
...
class Projects(models.Model):
    ...
    project_details = models.ForeignKey("ProjectDiscription", on_delete=models.CASCADE, null=True,related_name="proj")
